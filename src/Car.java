public class Car extends Auto {
    ...
    public Car(String firma, int speed, int gosNum, String name, int n, Boolean f){
        super(firma, speed, gosNum); //вызываем конструктор класса-родителя с параметрами (см. класс Auto)
